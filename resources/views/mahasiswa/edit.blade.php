                ...
                <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="pendidikan" 
                                value="{{ old('pendidikan', $mahasiswa->pendidikan) }}" 
                                class="w-full border rounded-2xl p-2 mt-1" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="ragam_disabilitas" 
                                value="{{ old('ragam_disabilitas', $mahasiswa->ragam_disabilitas) }}" 
                                class="w-full border rounded-2xl p-2 mt-1" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="surat_keterangan_link" 
                                value="{{ old('surat_keterangan_link', $mahasiswa->surat_keterangan_link) }}" 
                                class="w-full border rounded-2xl p-2 mt-1">
                        </div>
                        ...
                        <div>
                            ...
                            @if($mahasiswa->surat_keterangan)
                                <p class="mt-1 text-sm text-gray-500">File lama: {{ $mahasiswa->surat_keterangan }}</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            ...
                            <textarea name="detail_disabilitas" class="w-full border rounded-2xl p-2 mt-2">{{ old('detail_disabilitas', $mahasiswa->detail_disabilitas) }}</textarea>
                        </div>

                        <div class="col-span-2">
                            <label class="block font-medium text-[#083D62]">Alat Bantu</label>
                            <textarea name="alat_bantu" class="w-full border rounded-2xl p-2 mt-2">{{ old('alat_bantu', $mahasiswa->alat_bantu) }}</textarea>
                        </div>

                        <div class="col-span-2">
                            <label class="block font-medium text-[#083D62]">Kesulitan/Kendala saat proses belajar</label>
                            <textarea name="kendala" class="w-full border rounded-2xl p-2 mt-2">{{ old('kendala', $mahasiswa->kendala) }}</textarea>
                        </div>

                        <div class="col-span-2">
                            <label class="block font-medium text-[#083D62]">Akomodasi yang diperlukan</label>
                            <textarea name="akomodasi" class="w-full border rounded-2xl p-2 mt-2">{{ old('akomodasi', $mahasiswa->akomodasi) }}</textarea>
                        </div>

                        <div class="col-span-2">
                            <label class="block font-medium text-[#083D62]">Pendampingan atau layanan</label>
                            <textarea name="pendampingan" class="w-full border rounded-2xl p-2 mt-2">{{ old('pendampingan', $mahasiswa->pendampingan) }}</textarea>
                        </div>
                    </div>
