...
<body>
    ...
    <div class="section">
        <p style="margin: 2px 0;"><span>Nama</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $alumni->nama }}</p>
        <p style="margin: 2px 0;"><span>Jenis kelamin</span>&nbsp;&nbsp;: {{ $alumni->jenis_kelamin ?? '-' }}</p>
        <p style="margin: 2px 0;"><span>Disabilitas</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $alumni->ragam_disabilitas ?? '-' }}</p>
        <p style="margin: 2px 0;">
            <span>Tanggal lahir</span>&nbsp;&nbsp;&nbsp;: 
            {{ $alumni->tanggal_lahir ? \Carbon\Carbon::parse($alumni->tanggal_lahir)->format('d/m/Y') : '-' }}
        </p>
        <p style="margin: 2px 0;"><span>Fakultas</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $alumni->fakultas ?? '-' }}</p>
        <p style="margin: 2px 0;"><span>Prodi</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $alumni->prodi ?? '-' }}</p>
        <p style="margin: 2px 0;"><span>NIM</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $alumni->nim }}</p>
    </div>

    <div class="section">
        <p style="margin: 2px 0;"><b>Kondisi disabilitas:</b></p>
        <p style="margin: 2px 0; text-align: justify;">{{ $alumni->detail_disabilitas ?? '-' }}</p>
    </div>

    <div class="section">
        <p style="margin: 2px 0;"><b>Kesulitan yang dialami saat belajar:</b></p>
        <p style="margin: 2px 0; text-align: justify;">{{ $alumni->kendala ?? '-' }}</p>
    </div>

    <div class="section">
        <p style="margin: 2px 0;"><b>Kebutuhan/fasilitasi penyesuaian akomodasi layak yang diperlukan:</b></p>
        <p style="margin: 2px 0; text-align: justify;">{{ $alumni->akomodasi ?? '-' }}</p>
    </div>
