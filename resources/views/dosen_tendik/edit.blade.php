                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="fakultas" 
                                value="{{ old('fakultas', $tendik->fakultas) }}" 
                                class="w-full border rounded-2xl p-2 mt-1" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="angkatan" 
                                value="{{ old('angkatan', $tendik->angkatan) }}" 
                                class="w-full border rounded-2xl p-2 mt-1" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_hp" 
                                value="{{ old('nomor_hp', $tendik->nomor_hp) }}" 
                                class="w-full border rounded-2xl p-2 mt-1" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="ragam_disabilitas" 
                                value="{{ old('ragam_disabilitas', $tendik->ragam_disabilitas) }}" 
                                class="w-full border rounded-2xl p-2 mt-1" required>
                        </div>
