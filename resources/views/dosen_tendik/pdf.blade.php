...
<body>
    ...
    <h4>Asesmen Dosen/Tenaga Pendidik Disabilitas</h4>
    <h4>Universitas Gadjah Mada</h4>

    <div class="section">
        <p style="margin: 2px 0;"><span>Nama</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $tendik->nama }}</p>
        <p style="margin: 2px 0;"><span>Jenis kelamin</span>&nbsp;&nbsp;: {{ $tendik->jenis_kelamin ?? '-' }}</p>
        <p style="margin: 2px 0;"><span>Disabilitas</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $tendik->ragam_disabilitas ?? '-' }}</p>
